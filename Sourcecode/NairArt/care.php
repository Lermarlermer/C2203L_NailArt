...
<body>
    ...
    <div class="wrapper">
        ...
        <main id="Main">
            <?php
                $Care = new Care();
                $MyArrayX = $Care->ShowAllCare();
                $stringX = "";
                for ($i = 0; $i < count($MyArrayX); $i++) {
                    $ObjX = $MyArrayX[$i];

                    $stringX .= '
                    <a class="item_care" href="./care-detail.php?careid='. $ObjX->CareID . '">
                        <div class="care-ctnr">
                            <div class="care-img">
                                <img src="'. $ObjX->CarePictureLink . '">
                            </div>
                            <div class="care-info contentbreak">
                                <p class="care-title">'. $ObjX->CareTitle . '</p>
                                <p class="care-description">'. $ObjX->CareDescription . '</p>
                            </div>                            
                        </div>
                    </a>
                    ';
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-6 col-6">
                        <ul class="list-unstyled nav-links">
                            ...
                            <li><a href="./care.php">Course</a></li>
