...
<body>
    ...
    <div class="wrapper">
        ...
        <main id="Main">
            <div class="divleft">
                <h3 class="title" id="Axc0">COURSE CATEGORIES</h3>
                <ul class="listX">
                    <?php
                        $CategoriesVarX = new CategoriesOfCourse();
                        $_SESSION['ParentID'] = 0;
                        ...
                        for ($i = 0; $i < count($MyArrayX); $i++) {
                            $ObjX = $MyArrayX[$i];
                            $stringX .= '
                                <li class="X0" id="Axc'. $i + 1 .'">' . $ObjX -> CategoriesName .'</li>
                            ';
                        }
                        echo $stringX;                        
                    ?>
            ...
            <div class="divright">
                <div class ="lnkgrp">
                    <a href="./home.php">Home</a> » <a href="./course.php">Course</a>
                </div>    
